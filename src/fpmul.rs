...
//         a: poly_eval::Config<16, F>,
//         b: poly_eval::Config<16, F>,
//         q: poly_eval::Config<16, F>,
//         n: poly_eval::Config<16, F>,
//         r: poly_eval::Config<16, F>,
//         ab: poly_eval::Config<16, F>,
//         qn_r: poly_eval::Config<16, F>,
//         mul_cfgs: MulConfigs,
//         x: Challenge,
...
//             let ab = poly_eval::Config::configure(meta, ab_cols.0, ab_cols.1, x, range_check, table);

//             let qn_r = poly_eval::Config::configure(meta, qn_r_cols.0, qn_r_cols.1, x, range_check, table);
